...
<html lang="zh-CN">
    <head>
	    ...
	    function showImg(url) {
	   		 art.dialog.open(url,{width:500 ,height: 500 , title: '奖品图片',id:'trophy_image'});
	   	 }
		</script>
                         ...
                         <s:form action="trophy_edit" id="myform" name="myform" namespace="/manage/credit" method="post" enctype="multipart/form-data"  > 
	    					...
	    					<div class="form-horizontal">
		    					 <div class="form-group">
								    ...
								    <div class="col-sm-4">
								      <select name="trophy.state" class="form-control"  >
								      	<option ${trophy.state==1?"selected='selected'":""} value="1" >可以兑换</option>
								      	<option ${trophy.state==0?"selected='selected'":""} value="0" >停止兑换</option>
								      </select>
								    </div>
								  </div>
		    					 <div class="form-group">
								    ...
								    <div class="col-sm-4">
								      <select name="typeid" class="form-control"  >
								      	<c:forEach items="${types}" var="entry">   
								      		<option value="${entry.id }" ${entry.id==trophy.trophyType.id?"selected='selected'":""}>${entry.name}</option>
								      	</c:forEach>
								      </select>
								    </div>
								  </div>
		    					 ...
		    					 <div class="form-group">
								    ...
								    <div class="col-sm-10">
								    <textarea  name="trophy.detail" >${trophy.detail}</textarea>
    					 			</div>
								 </div>
