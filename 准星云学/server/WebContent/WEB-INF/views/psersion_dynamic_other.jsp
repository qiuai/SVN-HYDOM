	...
	<div class="customer">
		<div class="panel panel-primary-head">
			<ul class="nav nav-tabs nav-line" style="height: 42px;">
				<li class="" onclick="getEvent()" id="event"><a href="#following"
					data-toggle="tab" style="color: #555;"><strong>本人事件(<%=request.getAttribute("totalCount1") %>)</strong> </a>
				</li>
				<li class="active" onclick="getOtherEvent()" id="otherEvent"><a href="#following"
		...
		<form id="listForm" name="listForm"	action="<%=basePath%>event/dynamic.do?activeEvent=2" method="post">
		<%--条件搜索	--%>
		<div class="well">
			<div class="col-ms-12">
...
<%--										<label style=" margin-left: 88%;margin-top: -24px;">--%>
