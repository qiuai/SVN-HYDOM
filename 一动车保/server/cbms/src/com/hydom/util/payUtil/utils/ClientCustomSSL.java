 ...
 *
 */
package com.hydom.util.payUtil.utils;
...
public class ClientCustomSSL {
	...
	public static String doRefund(String url,String data,String partner) throws Exception {
        ...
        String fileUrl = ClientCustomSSL.class.getResource("/META-INF/apiclient_cert.p12").getFile();
        System.out.println(fileUrl);
        FileInputStream instream = new FileInputStream(new File(fileUrl));//P12文件目录
        try {
        	/**
        	 * 此处要改
        	 * */
