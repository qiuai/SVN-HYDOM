				...
				<div class="contentpanel">
					<div class="panel panel-default">
						...
						<form class="form-horizontal form-bordered" id="inputForm"
							action="<%=basePath%>manage/coupon/update" method="POST">
							...
							<div class="panel-body nopadding">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="name" CHname="名字" 
											onBlur="check(this)" placeholder="请填写优惠券名称" id="name" value="${coupon.name }">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="input-group">
											<input type="text" class="form-control hasDatepicker" placeholder="不填代表从现在开始" id="beginDate" name="beginDate" 
											onclick="getLaydate('beginDate')" value="${coupon.beginDate}">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="input-group">
											<input type="text" class="form-control hasDatepicker" placeholder="不填代表永久有效" id="endDate" name="endDate" 
											onclick="getLaydate('endDate')" value="${coupon.endDate }">
											<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="introduction" placeholder="请填写优惠券介绍" maxlength="255" value="${coupon.introduction }">
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="rdio rdio-default" style="width: 140px;">
											<input type="radio" name="isEnabled" id="radioZH-One" value="1" <c:if test="${coupon.isEnabled eq true}">checked="checked"</c:if>>
											<label for="radioZH-One">是</label>
										</div>
										<div class="rdio rdio-default" style="width: 140px;">
											<input type="radio" name="isEnabled" id="radioZH-two" value="0" <c:if test="${coupon.isEnabled eq false}">checked="checked"</c:if>>
								...
								<div class="form-group">
									...
									<div class="col-sm-8" onchange="isExchange()">
										<div class="rdio rdio-default" style="width: 140px;">
											<input type="radio" name="isExchange" id="radioZH-3" value="1" <c:if test="${coupon.isExchange eq true}">checked="checked"</c:if>>
											<label for="radioZH-3">是</label>
										</div>
										<div class="rdio rdio-default" style="width: 140px;">
											<input type="radio" name="isExchange" id="radioZH-4" value="0" <c:if test="${coupon.isExchange eq false}">checked="checked"</c:if>>
								...
								<div class="form-group" id="pointDiv">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="point" id="point" placeholder="请填写积分数" maxlength="11" CHname="积分" 
										onBlur="check(this)" value="${coupon.point }">
										<input type="hidden" class="repeat"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-8 rdio3" onchange="couponType()">
										<div class="rdio rdio-default" style="width: 140px;">
											<input type="radio" name="type" id="radioZH-5" value="1" <c:if test="${coupon.type eq 1}">checked="checked"</c:if>>
											<label for="radioZH-5">满额打折</label>
										</div>
										<div class="rdio rdio-default" style="width: 140px;">
											<input type="radio" name="type" id="radioZH-6" value="2" <c:if test="${coupon.type eq 2}">checked="checked"</c:if>>
											<label for="radioZH-6">满额优惠</label>
										</div>
										<div class="rdio rdio-default" style="width: 140px;">
											<input type="radio" name="type" id="radioZH-7" value="3" <c:if test="${coupon.type eq 3}">checked="checked"</c:if>>
								...
								<div class="form-group" id="discountDiv">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="discount" id="discount" placeholder="请填写折扣额" CHname="折扣额" 
										onBlur="check(this)" value="${coupon.discount }">
										<input type="hidden" class="repeat"/>
								...
								<div class="form-group" id="minPriceDiv">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="minPrice" id="minPrice" placeholder="请填写最小商品价格" CHname="价格" 
										onBlur="check(this)" value="${coupon.minPrice }">
										<input type="hidden" class="repeat"/>
