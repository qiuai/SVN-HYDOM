				...
				.post(
						...
						function(data) {
							if(name == "" || name == null){
								...
								$("#name").next().val("");
							} else if (data == true && name!="${carBrand.name }") {//表示品牌存在
				...
				<div class="contentpanel">
					<div class="panel panel-default">
						...
						<form class="form-horizontal form-bordered" id="inputForm"
							action="<%=basePath%>manage/carBrand/update" method="POST">
							...
							<div class="panel-body nopadding">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="name"
											onBlur="checkName()" placeholder="请填写汽车品牌名称" id="name" value="${carBrand.name }">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="initial" maxlength="1" onblur="checkNull(this)" CHname="拼音首字母" 
										onkeyup="checkNull(this)" placeholder="请填写品牌拼音首字母" id="initial" value="${carBrand.initial }">
										<input type="hidden" class="repeat"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										onkeyup="checkNull(this)" placeholder="请填写品牌拼音缩写" id="jp" value="${carBrand.jp }">
										<input type="hidden" class="repeat"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										...
										onkeyup="checkNull(this)" placeholder="请填写品牌全拼" id="qp" value="${carBrand.qp }">
										<input type="hidden" class="repeat"/>
