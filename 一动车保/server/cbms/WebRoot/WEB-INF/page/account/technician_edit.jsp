				...
				<div class="contentpanel">
					<div class="panel panel-default">
						...
						<form class="form-horizontal form-bordered" id="inputForm"
							action="<%=basePath%>manage/technician/update" method="POST">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="account"
											onBlur="checkAccount()" placeholder="请填写帐号" id="account" value="${technician.account }">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="name"
											onBlur="checkName()" placeholder="请填写姓名" id="name" value="${technician.name }">
										<input type="hidden" class="repeat"/>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="phonenumber"
											onBlur="checkPhoneNumber()" placeholder="请填写联系方式" id="phonenumber" value="${technician.phonenumber }">
										<input type="hidden" class="repeat"/>
