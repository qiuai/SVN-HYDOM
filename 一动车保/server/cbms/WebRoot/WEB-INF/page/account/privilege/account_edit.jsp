			...
			<div class="mainpanel">
				...
				<div class="contentpanel">
					<div class="panel panel-default">
						...
						<form class="form-horizontal form-bordered" id="myform" action="${pageContext.request.contextPath}/manage/account/update" method="POST">
							<input type="hidden"  name="id" value="${account.id}">
							<div class="panel-body nopadding">
								<div class="form-group">
									<label class="col-sm-4 control-label">用户名</label>
									<div class="col-sm-8">
										<input type="text" class="form-control" name="username" value="${account.username }" id="username" readonly="readonly">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control" name="nickname" value="${account.nickname }"> <span></span>
									</div>
								</div>
							</div>
									...
									<div class="col-md-12 col-sm-12" style="padding:35px;">
										<c:forEach items="${groups}" var="group" varStatus="s">
											<div class="col-md-3 col-sm-4">
												<input type="checkbox" name="gids" value="${group.id}" ${fn:contains(ugs, group.id)?"checked='checked'":""}/> <a
