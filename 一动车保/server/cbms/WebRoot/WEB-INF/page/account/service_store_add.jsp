								...
								<div class="form-plan-div">
									...
									<div class="form-group">
										...
										<div class="col-sm-8 labeldiv">
											<label><input type="checkbox" name="supportGoHome" value="true"/>上门服务</label>
											<label><input type="checkbox" name="supportClean" value="true"/>洗车</label>
										</div>
									</div>
										...
										<div class="col-sm-8 labeldiv">
											<c:forEach var="value" items="${serviceTypes }">
												<c:if test="${value.type eq 1}">
													<label><input type="checkbox" name="serviceTypeIds" value="${value.id }"/>${value.name }</label>
												</c:if>
											</c:forEach>
										</div>
									</div>
