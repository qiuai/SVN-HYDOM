...
<%@page import="net.shop.Setting"%>
<%@page import="net.shop.util.SettingUtils"%>
<%@page import="net.shop.util.SpringUtils"%>
<%@page import="net.shop.Setting.CaptchaType"%>
<%@page import="net.shop.Setting.AccountLockType"%>
<%@page import="net.shop.service.RSAService"%>
		...
		<div class="login">
			<form id="loginForm" action="login.jsp" method="post">
				...
				<table>
					<tr>
						<td width="190" rowspan="2" align="center" valign="bottom">
							<img src="<%=base%>/resources/admin/images/login_logo_new.png"  />
						</td>
						<th>
				...
				<div class="link">
					...
					<a href="<%=base%>/"><%=SpringUtils.getMessage("admin.login.license")%></a>
				</div>
			</form>
		</div>
	<%} else {%>
