...
<body>
	...
	<form id="listForm" action="list.jhtml" method="get">
		<input type="hidden" id="typeName" name="type" value="${type}" />
		<input type="hidden" id="typeName" name="searchProperty" value="${type}" />
		<div class="bar">
			...
			<div class="buttonWrap">
				...
				<div class="menuWrap">
					<a href="javascript:;" id="filterSelect" class="button">
						服务筛选<span class="arrow">&nbsp;</span>
					</a>
					<div class="popupMenu">
						<ul id="filterOption" class="check">
							<li>
								<a href="javascript:;" name="typeName" val="1">商品服务</a>
							</li>
							<li>
								<a href="javascript:;" name="typeName" val="2">美容服务</a>
							</li>
						</ul>
					</div>
				</div>
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						...
						<li>
							<a href="javascript:;"[#if page.searchProperty == "id"] class="current"[/#if] val="id">编号</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="productCategory">服务分类</a>
				</th>
				<th>
			...
			[#list page.content as services]
				<tr>
					...
					<td>
						<span title="${services.createDate?string("yyyy-MM-dd HH:mm:ss")}">${services.createDate}</span>
					</td>
					<td>
