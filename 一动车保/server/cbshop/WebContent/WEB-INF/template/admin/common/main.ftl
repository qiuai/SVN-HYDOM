...
<body>
	...
	<table class="main">
		<tr>
			<th class="logo">
				<a href="main.jhtml">
					<img src="${base}/resources/admin/images/header_logo_new.png" />
				</a>
			</th>
			<th>
				<div id="nav" class="nav">
					<ul>
						[#list ["admin:carBrand"] as permission]
								<li>
									<a href="#car">${message("admin.main.carNav")}</a>
								</li>
								[#break /]
						[/#list]
				...
				<div class="link">
					<a href="${base}/" target="_blank">${message("admin.main.official")}</a>|
					<a href="${base}/" target="_blank">${message("admin.main.bbs")}</a>|
					<a href="${base}/" target="_blank">${message("admin.main.about")}</a>
				</div>
				<div class="link">
		...
		<tr>
			<td id="menu" class="menu">
				<dl id="car" class="default">
					<dt>${message("admin.main.carGroup")}</dt>
						<dd>
							<a href="../carBrand/list.jhtml" target="iframe">${message("admin.main.carBrand")}</a>
						</dd>
						<dd>
							<a href="../carType/list.jhtml" target="iframe">${message("admin.main.carType")}</a>
						</dd>
						<dd>
							<a href="../car/list.jhtml" target="iframe">${message("admin.main.car")}</a>
						</dd>
				</dl>
				<dl id="services" class="default">
					<dt>服务</dt>
					<dd>
						<a href="../service/list.jhtml" target="iframe">服务列表</a>
					</dd>
					<dd>
						<a href="../service/list.jhtml" target="iframe">服务类型</a>
					</dd>
