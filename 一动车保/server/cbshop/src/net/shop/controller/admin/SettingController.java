...
import net.shop.FileInfo.FileType;
import net.shop.Message;
import net.shop.Setting;
import net.shop.Setting.AccountLockType;
import net.shop.Setting.CaptchaType;
import net.shop.Setting.ConsultationAuthority;
import net.shop.Setting.ReviewAuthority;
import net.shop.Setting.RoundType;
import net.shop.Setting.StockAllocationTime;
import net.shop.Setting.WatermarkPosition;
