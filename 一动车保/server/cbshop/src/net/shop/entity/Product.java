...
import net.shop.BigDecimalNumericFieldBridge;
...
public class Product extends BaseEntity {
	...
	/**所属服务*/
	private Set<ServicesType> servicesTypeSet = new HashSet<ServicesType>();
	...
	@Valid
	@ElementCollection
	@CollectionTable(name = "cb_product_product_image")
	 ...
	 */
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "cb_product_specification")
	@OrderBy("order asc")
	 ...
	 */
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "cb_product_specification_value")
	...
	@CollectionTable(name = "cb_product_member_price")
	 ...
	 */
	@ElementCollection(fetch = FetchType.LAZY)
	@CollectionTable(name = "cb_product_parameter_value")
	...
	@JoinTable(name = "cb_product_service_type", joinColumns = { @JoinColumn(name = "product_id") }, inverseJoinColumns = { @JoinColumn(name = "service_type_id") })
