...
#define ColorLanBg [UIColor colorWithRed:71/255.0 green:166/255.0 blue:236/255.0 alpha:1.0]
#import "ZHPickView.h"
...
-(UIToolbar *)setToolbarStyle{
    ...
    toolbar.barTintColor = ShareBackColor;
...
-(void)doneClick
{
    if (_pickerView) {
        ...
        NSDate *destDate=  _datePicker.date;
         _resultString = [dateFormatter stringFromDate:destDate];
    }
