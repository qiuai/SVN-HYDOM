...
package com.carinsurance.pagerslidingtabstrip;
...
//toUpperCase Api14以前的变成大写的方法
//setAllCaps  API14以后的  为设置所有TextView大写
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF64A01D;// 绿色
	// #
	...
	private int selectTextColor;// 自己加上的，选中的textView的颜色
	boolean is_chushihua = true;// 是否是初始化
...
//		pstsSelectTabsColor
	...
	private class PageListener implements OnPageChangeListener {
		...
		public PageListener() {
			// ((TextView)
			// tabsContainer.getChildAt(0)).setTextColor(selectTextColor);
		}
		...
		public void onPageScrollStateChanged(int state) {
			// Log.v("aaa", "onPageScrollStateChanged=" + state);
		...
		public void onPageSelected(int position) {
			...
			if (tabsContainer.getChildAt(0) instanceof TextView) {
				for (int i = 0; i < tabsContainer.getChildCount(); i++) {
					// if(tabsContainer.getChildAt(position) instanceof
					// TextView)
					// {
					((TextView) tabsContainer.getChildAt(i)).setTextColor(tabTextColor);
					// }
				}
				((TextView) tabsContainer.getChildAt(position)).setTextColor(selectTextColor);
				if (delegatePageListener != null) {
