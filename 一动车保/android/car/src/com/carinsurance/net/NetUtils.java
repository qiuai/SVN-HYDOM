...
public class NetUtils {
	 ...
	 * @param handler
	 */
	public void post(final String MethodName, final RequestParams requestParams, final Handler handler) {
		...
		th.send(HttpRequest.HttpMethod.POST, Task.url + MethodName, requestParams, new RequestCallBack<String>() {
			...
			public void onFailure(HttpException arg0, String arg1) {
				...
				if (xUtilsNetInterface != null) {
					...
					Log.v("aaa", "接口地址=" + Task.url + "/" + MethodName + "网络访问状况：onFailure" + "/arg0=" + arg0 + "/arg1=" + arg1);
			...
			public void onLoading(long total, long current, boolean isUploading) {
				...
				if (xUtilsNetInterface != null) {
					xUtilsNetInterface.onLoading(total, current, isUploading);
				} else {
				}
			...
			public void onSuccess(ResponseInfo<String> responseInfo) {
				...
				if (xUtilsNetInterface != null) {
					...
					// Log.v(Tag,"t="+t);
					Log.v("aaa", "接口地址=" + Task.url + MethodName + "/" + "网络访问状况=" + "onSuccess" + "返回消息内容=" + t);
					Message msg = new Message();
	 ...
	 * @param handler
	 */
	public void post(final String MethodName, final HashMap<String, String> map, final Handler handler) {
		final String Tag = MethodName;
		...
		try {
			Log.v("sss1", "接口" + MethodName + "提交的数据是" + (map.toString().replace(",", "&").replace(" ", "")));
		} catch (Exception e) {
			// TODO: handle exception
		}
		try {
			Log.v("sss2", "接口" + MethodName + "原始不做处理提交的数据是" + (map.toString().replace(",", "&")));
		} catch (Exception e) {
			// TODO: handle exception
		}
		// TODO Auto-generated method stub
	 ...
	 * @param handler
	 */
	public void get(final String MethodName, final HashMap<String, String> map, final Handler handler) {
		final String Tag = MethodName;
		...
		th.send(HttpRequest.HttpMethod.GET, Task.url + MethodName, requestParams, new RequestCallBack<String>() {
	...
	public void post(final String MethodName, final RequestParams requestParams, final Handler handler, final String data) {
		final String Tag = MethodName;
		// TODO Auto-generated method stub
		// new Thread(new Runnable() {
		// @Override
	 ...
	 * @param Tag
	 */
	public void get(final String MethodName, RequestParams params, final Handler handler) {
		final String Tag = MethodName;
		// TODO Auto-generated method stub
		// new Thread(new Runnable() {
		// @Override
		...
		// params.addBodyParameter("phone", "15198183412");
		HttpUtils th = new HttpUtils();
		th.send(HttpRequest.HttpMethod.GET, Task.url + "/" + MethodName, params, new RequestCallBack<String>() {
	...
	public void post_async(final String MethodName, final com.loopj.android.http.RequestParams params, final Handler handler) {
		...
		AsyncHttpHelp.post(Task.url + "/" + MethodName, params, new AsyncHttpResponseHandler() {
	...
	public HttpHandler<Object> post(String url, com.lidroid.xutils.http.RequestParams params, RequestCallBack<Object> requestCallBack) {
		HttpUtils th = new HttpUtils();

		return th.send(HttpRequest.HttpMethod.POST, url, params, requestCallBack);
	 ...
	 *            handler
	 */
	public void getWeather(final String cityName, final Handler handler, final String Tag) {
		...
		HttpUtils th = new HttpUtils();
		String path = NetPath + "?location=" + cityName + "&output=json&ak=" + WeatherKey;
		th.send(HttpRequest.HttpMethod.GET, path, params, new RequestCallBack<String>() {

			@Override
			public void onFailure(HttpException arg0, String arg1) {
				// TODO Auto-generated method stub
				Log.v("aaa", "接口地址=" + NetPath + "网络访问状况：onFailure" + "/arg0=" + arg0 + "/arg1=" + arg1);
				Message msg = new Message();
				Bundle bun = new Bundle();
				bun.putString(GET_TAG, ("" + Tag));
				msg.what = Net_Failure;
	 ...
	 *            其他请求标识
	 */
	public void post(final String MethodName, final HashMap<String, String> map, final Handler handler, final Bundle tags) {
		final String Tag = MethodName;
