...
public class Mendian_leftlistview_adapter extends BaseAdapter {

	Context context;

	public Mendian_leftlistview_adapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.mendian_left_listview_adatper_item, null);
			// holder.img=
