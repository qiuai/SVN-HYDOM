...
public class Shop_detailstab1_adapter extends BaseAdapter {

	Context context;

	public Shop_detailstab1_adapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.shop_details_tab1_adapter_item, null);
			// holder.img=
