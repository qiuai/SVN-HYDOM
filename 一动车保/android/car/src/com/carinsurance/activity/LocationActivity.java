...
//activity_location
public class LocationActivity extends BaseActivity implements OnClickListener, LocationSource, AMapLocationListener, OnGeocodeSearchListener, OnMapClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.findViewById(R.id.fuwu_fanwei).setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				JumpUtils.jumpto(LocationActivity.this, ServierFanWeiActivity.class, null);
			}
		});
		init();
	}
	...
	private void setUpMap() {
		// TODO Auto-generated method stub
		aMap.moveCamera(CameraUpdateFactory.newLatLngZoom(Constants.CHENGDU, 12));// 设置指定的可视区域地图
...
//				addressName = getResources().getString(R.string.l_xb97) + address.getLatLonPoint() + "\n" + getResources().getString(R.string.l_xb98) + address.getFormatAddress();
				// 这里保存要上传的经纬度
				latLonPoint = address.getLatLonPoint();
				Log.v("aaa", "latLonPoint+++>" + latLonPoint.getLatitude() + "///" + latLonPoint.getLongitude());

				Utils.showMessage(LocationActivity.this, addressName);
//				Toast.makeText(LocationActivity.this, addressName);
			} else {
				ToastUtil.show(LocationActivity.this, "对不起，没有搜索到相关资料！");
				
			}

		} else if (rCode == 27) {
			ToastUtil.show(LocationActivity.this, "网络错误");
		} else if (rCode == 32) {
			ToastUtil.show(LocationActivity.this, "key错误");
		} else {
			ToastUtil.show(LocationActivity.this, "未知错误");
		}
	}
...
//				regeoMarker.setPosition(AMapUtil.convertToLatLng(latLonPoint));
				...
				AMapUtils.drawZidingyiMarker(LocationActivity.this, aMap, AMapUtil.convertToLatLng(latLonPoint), "1");
				
				
				ToastUtil.show(LocationActivity.this, "当前地址:"+addressName);
			} else {
				ToastUtil.show(LocationActivity.this, "对不起，没有搜索到相关资料！");
			}
		} else if (rCode == 27) {
...
//			LocationActivity.this.finish();
			JumpUtils.jumpfinish(LocationActivity.this);
			break;
		case R.id.send:
			// addressName
			...
			if(StringUtil.isNullOrEmpty(""+latLonPoint.getLongitude()) || StringUtil.isNullOrEmpty(""+latLonPoint.getLatitude()) || StringUtil.isNullOrEmpty(addressName))
			{
				
				Utils.showMessage(LocationActivity.this, "请选择当前地理位置！");
				break;
			}
...
//			JumpUtils.jumpto(LocationActivity.this, SelectMenDianActivity.class, locationInfos);
//			setResult(2, it);
			finish();
			break;
		}
