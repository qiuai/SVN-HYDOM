...
import com.carinsurance.my_view.pull.ILoadingLayout.State;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected void addRefreshableView(Context context, T refreshableView) {
        ...
        mRefreshableViewWrapper.setFadingEdgeLength(0);
        mRefreshableViewWrapper.setHorizontalFadingEdgeEnabled(false);
        mRefreshableViewWrapper.setVerticalFadingEdgeEnabled(false);
