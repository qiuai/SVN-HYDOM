package com.carinsurance.my_view.pull;
...
public class ScaleImageView_kelasheng_a11 extends ImageView {
	...
	public ScaleImageView_kelasheng_a11(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		// TODO Auto-generated constructor stub
		initi(context);
	}

	public ScaleImageView_kelasheng_a11(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
		initi(context);
	}

	public ScaleImageView_kelasheng_a11(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initi(context);
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_POINTER_DOWN:
			...
			/** 计算两个手指间的中间�? */
			if (startDis > 10f) { // 两个手指并拢在一起的时�?�像素大�?10
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (POINT_COUNT == 1) {
				...
				if (endDis > 10f) { // 两个手指并拢在一起的时�?�像素大�?10
