...
public class AsyncHttpClient
{
	...
	{
		sendRequest(httpClient, httpContext, new HttpHead(getUrlWithQueryString(url, params)), null, responseHandler,
				context);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void head(Context context, String url, Header[] headers, RequestParams params,
